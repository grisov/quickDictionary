...
Также присутствуют расширенные функции для работы с профилями голосовых синтезаторов. Вы можете ассоциировать профиль синтезатора голоса с определенным языком, после чего переводы на этот язык будут автоматически озвучиваться выбранным синтезатором.
...
Чтобы воспользоваться этой возможностью, сначала необходимо создать и сохранить профили голосовых синтезаторов, а затем в диалоговом окне настройки дополнения ассоциировать эти профили с языками для которых они будут активироваться.
После этого при получении перевода для каждого заданного языка будет автоматически включаться ассоциированный с ним голосовой синтезатор.
...
Для каждого профиля в списке указан его номер, название синтезатора, имя голоса и язык, ассоциированный с ним.
...
Примечание: По умолчанию ассоциированный язык устанавливается как "- Постоянный язык -". Это означает, что переключение на этот синтезатор не будет осуществляться. Процесс изменения ассоциированного языка для каждого профиля будет рассмотрен ниже.
