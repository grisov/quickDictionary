...
После выполнения предварительных настроек, при получении данных из словаря будет автоматически включаться выбранный вами голосовой синтезатор. А после окончания объявления статьи снова будет включаться синтезатор по умолчанию.

Примечание: Переключение синтезаторов происходит в начале и после объявления словарной статьи. Если вы прервали текущее объявление, то синтезатор по умолчанию не будет активирован автоматически. Поэтому вам придется переключиться к нему вручную. Это можно сделать очень просто: нажав NVDA+Y, а затем - R. Готово.
