...
Скористайтесь клавішею U в режимі керування додатком для того, щоб завантажити та зберегти з онлайн-словника актуальний список доступних вихідних мов та мов призначення.
...
Після виконання попередніх налаштувань, при отриманні даних зі словника буде автоматично вмикатись обраний вами голосовий синтезатор. А після закінчення оголошення статті знову буде вмикатись синтезатор за замовчуванням.

Примітка: Перемикання синтезаторів відбувається на початку та після оголошення словникової статті. Якщо ви перервали поточне оголошення, то синтезатор за замовчуванням не буде активований автоматично. Тому вам доведеться перемкнутись до нього вручну. Це можна зробити дуже просто: натиснувши NVDA+Y, а потім - R. Готово.
