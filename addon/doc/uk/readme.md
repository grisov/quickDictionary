...
Перейшовши до списку вихідних мов, клавішами вгору або вниз оберіть потрібну мову та натисніть Tab для переходу до вибору мови призначення.

Примітка:
* Список доступних мов призначення залежить від обраної вихідної мови, тому мову призначення потрібно обирати лише після встановлення вихідної мови.
