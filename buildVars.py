...
addon_info = {
    ...
    "addon_version" : "1.0",
    # Author(s)
    "addon_author" : u"Oleksandr Gryshchenko <grisov.nvaccess@mailnull.com>",
    ...
    # Last NVDA version supported/tested (e.g. "2020.3.0", ideally more recent than minimum version)
